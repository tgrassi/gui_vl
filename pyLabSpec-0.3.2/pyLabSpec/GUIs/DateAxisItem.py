...
#
"""
This module is exactly what is pending as a pull request into pyqtgraph
(https://github.com/pyqtgraph/pyqtgraph/pull/74). It seems to work as-is.
"""
import time
...
class DateAxisItem(AxisItem):
    ...
    def setZoomLevelForDensity(self, density):
        keys = sorted(list(self.zoomLevels.keys()))
